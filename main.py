...
import Subset_Font
import merge_pdf
from my_sarvam_translator import translate_batch
import gc

if hasattr(fitz, "TOOLS"):
    print("stored max size set to 1GB")
    fitz.TOOLS.store_maxsize = 1024 * 1024 * 1024
...
class main_function:
    ...
    def main(self):
        ...
        # new_doc.save(target_path, garbage=4,  deflate=False)
        # new_doc.close()
    ...
    def batch_translate_pages_data(self, original_language, target_language,
        ...
        while start_idx < total_pages:
            ...
            if self.translation and use_mupdf:
                translation_list =translate_batch(batch_texts, original_language, target_language)
